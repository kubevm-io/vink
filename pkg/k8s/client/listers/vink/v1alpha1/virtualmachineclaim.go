...
type VirtualMachineClaimLister interface {
	...
	List(selector labels.Selector) (ret []*v1alpha1.VirtualMachineClaim, err error)
...
type virtualMachineClaimLister struct {
	listers.ResourceIndexer[*v1alpha1.VirtualMachineClaim]
}
...
func NewVirtualMachineClaimLister(indexer cache.Indexer) VirtualMachineClaimLister {
	return &virtualMachineClaimLister{listers.New[*v1alpha1.VirtualMachineClaim](indexer, v1alpha1.Resource("virtualmachineclaim"))}
}

// VirtualMachineClaims returns an object that can list and get VirtualMachineClaims.
func (s *virtualMachineClaimLister) VirtualMachineClaims(namespace string) VirtualMachineClaimNamespaceLister {
	return virtualMachineClaimNamespaceLister{listers.NewNamespaced[*v1alpha1.VirtualMachineClaim](s.ResourceIndexer, namespace)}
}
...
type VirtualMachineClaimNamespaceLister interface {
	...
	// Objects returned here must be treated as read-only.
	Get(name string) (*v1alpha1.VirtualMachineClaim, error)
